...
class SpareSplitter():
    ...
    def specials_list(self, master_list):
        specials_list = master_list[master_list["Filename"].apply(lambda x: "- GAS" not in x and "- OIL" not in x and "- CW" not in x and "- SEAL" not in x and "- INSULATING" not in x and "- CONDENSATE" not in x)]
